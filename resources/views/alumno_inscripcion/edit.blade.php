<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form action="{{ route('student_enrollments.update', $student_enrollment->alu_id) }}" method="POST"
                id="edit_student_enrollment">
                @csrf
                @method('PUT')
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-group-default required">
                                ...
                                <select class="form-control" name="alu_car_id" id="alu_car_id">
                                    @if (!empty($student_enrollment->alu_car_id))
                                        <option value="{{ $student_enrollment->alu_car_id }}" selected>
                                            {{ $student_enrollment->degree->car_nombre }}
                                        </option>
                                    @endif
                                </select>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-group-default required">
                                ...
                                <input name="alu_fec_ing" type="date" class="form-control" id="alu_fec_ing"
                                    value="{{ $student_enrollment->alu_fec_ing }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group form-group-default required">
                    ...
                    <div class="row">
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="checkbox" value=""
                                        {{ $student_enrollment->alu_estado ? 'checked' : '' }} name="alu_estado">
                        ...
                        <div class="col-md-6">
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="checkbox" value=""
                                        {{ $student_enrollment->alu_con_car ? 'checked' : '' }} name="alu_con_car">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="alu_obs" rows="4" name="alu_obs" placeholder="Ingrese observación">{{ $student_enrollment->alu_obs }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
