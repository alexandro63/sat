<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form action="{{ route('administrative.update', $administrative->adm_id) }}" method="POST"
                id="edit_administrative">
                @csrf
                @method('PUT')
                        ...
                        <div class="col-sm-6">
                            <div class="form-group form-group-default required">
                                ...
                                <select class="form-control" name="adm_per_id" id="adm_per_id">
                                    @if (!empty($administrative->adm_per_id))
                                        <option value="{{ $administrative->adm_per_id }}" selected>
                                            (C.I. {{ $administrative->people->per_ci }})
                                            {{ $administrative->people->per_nombres }}
                                            {{ $administrative->people->per_apellidopat }}
                                            {{ $administrative->people->per_apellidomat }}
                                        </option>
                                    @endif
                                </select>
                            </div>
                            ...
                            <div class="form-group form-group-default required">
                                ...
                                <select class="form-control select2" name="adm_grado_academico" id="adm_grado_academico"
                                    ...
                                    @foreach ($grade_academic as $key => $grade)
                                        <option value="{{ $key }}"
                                            {{ $administrative->adm_grado_academico == $key ? 'selected' : '' }}>
                                            {{ $grade }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group form-group-default required">
                                ...
                                <input type="text" class="form-control" placeholder="Ingrese Cargo" name="adm_cargo"
                                    id="adm_cargo" value="{{ $administrative->adm_cargo }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group form-group-default required">
                                ...
                                <input name="adm_fec_ing" type="date" class="form-control" id="adm_fec_ing"
                                    value="{{ $administrative->adm_fec_ing }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group form-group-default required">
                                ...
                                <input type="text" class="form-control input-number" placeholder="Ingrese Salario"
                                    name="adm_pago" id="adm_pago" value="{{ $administrative->adm_pago }}">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group form-group-default required">
                                ...
                                <input name="adm_fec_ini" type="date" class="form-control" id="adm_fec_ini"
                                    value="{{ $administrative->adm_fec_ini }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-group-default required">
                                ...
                                <input name="adm_fec_fin" type="date" class="form-control" id="adm_fec_fin"
                                    value="{{ $administrative->adm_fec_fin }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-group-default">
                                ...
                                <textarea class="form-control" placeholder="Ingrese observaciones" name="adm_obs" id="adm_obs">
                                    {{ $administrative->adm_obs }}
                                </textarea>
                            </div>
                        </div>
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="checkbox" value=""
                                        {{ $administrative->adm_estado ? 'checked' : '' }} name="adm_estado">
