<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form action="{{ route('degrees.store') }}" method="POST" id="add_degree">
                @csrf
                <div class="row">
                    <div class="col-sm-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group form-group-default">
                            ...
                            <textarea name="car_descripcion" id="car_descripcion" placeholder="Ingrese descripción" rows="3" cols="45"></textarea>
                        </div>
                    </div>
