<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form action="{{ route('metodologias.update', $metodologia->id) }}" method="POST" id="edit_metodologia">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group form-group-default required">
                            ...
                            <input name="nombre" type="text" class="form-control" id="nombre"
                                placeholder="Ingrese nombre" value="{{ $metodologia->nombre }}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group form-group-default required">
                            ...
                            <input name="descripcion" type="text" class="form-control" id="descripcion"
                                placeholder="Ingrese descripción" value="{{ $metodologia->descripcion }}">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group form-group-default required">
                            ...
                            <input name="objetivos" type="text" class="form-control" id="objetivos"
                                placeholder="Ingrese objetivos" value="{{ $metodologia->objetivos }}">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group form-group-default required">
                            ...
                            <input name="numero_modulos" type="text" class="form-control input-number"
                                ...
                                value="{{ $metodologia->numero_modulos }}">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group form-group-default required">
                            ...
                            <input name="fecha_inicio" type="date" class="form-control" id="fecha_inicio"
                                value="{{ $metodologia->fecha_inicio }}">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group form-group-default required">
                            ...
                            <input name="fecha_finalizacion" type="date" class="form-control" id="fecha_finalizacion"
                                value="{{ $metodologia->fecha_finalizacion }}">
                        </div>
                    </div>
                </div>
